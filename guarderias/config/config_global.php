...
define("DIA_SORTEO",'2020/06/20');

define("DIA_PROVISIONALES",'2020/06/21');
define("DIA_DEFINITIVOS",'2020/06/23');
define("DIA_MATRICULA",'2020/07/30');

define("DIA_SORTEO_FASE2",'2020/07/12');

define("DIA_FASE3",'2020/08/26');
