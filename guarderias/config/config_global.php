...
define("DIA_INICIO_INSCRIPCION",'2020/05/13');
define("DIA_MAX_SOL_ALUMNO",'2020/05/15');
define("DIA_FIN_INSCRIPCION",'2020/05/19');

define("DIA_SORTEO",'2020/05/23');

define("DIA_BAREMACION",'2020/05/25');
define("DIA_PUBLICACION_BAREMACION",'2020/05/026');

define("DIA_PROVISIONALES",'2020/05/28');
