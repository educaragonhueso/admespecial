...
print("copiada $res");
if($res==1) echo "Copia tabla baremadas definitivo realizada corectamente a las ".date('H:m')." del dia ".date('d-M-Y').PHP_EOL;	
else "Error copiando tabla baremadas definitivo, ERROR: $res";
?>
