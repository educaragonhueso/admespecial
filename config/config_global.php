...
define("DIA_INICIO_INSCRIPCION",'2020/05/01');
define("DIA_MAX_SOL_ALUMNO",'2020/05/10');
define("DIA_FIN_INSCRIPCION",'2020/05/10');

define("DIA_SORTEO",'2020/05/10');

define("DIA_BAREMACION",'2020/05/11');
define("DIA_PUBLICACION_BAREMACION",'2020/05/011');

define("DIA_PROVISIONALES",'2020/05/11');
define("DIA_DEFINITIVOS",'2020/05/11');

define("DIA_SORTEO_FASE2",'2020/05/12');
