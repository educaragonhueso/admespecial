...
define("DIA_MAX_SOL_ALUMNO",'2020/05/06');
define("DIA_FIN_INSCRIPCION",'2020/05/07');

define("DIA_SORTEO",'2020/05/03');

define("DIA_BAREMACION",'2020/06/04');
define("DIA_PUBLICACION_BAREMACION",'2020/06/04');

define("DIA_PROVISIONALES",'2020/06/05');
