...
define("DIA_MAX_SOL_ALUMNO",'2020/05/01');
define("DIA_FIN_INSCRIPCION",'2020/05/01');

define("DIA_SORTEO",'2020/05/01');

define("DIA_BAREMACION",'2020/05/01');
define("DIA_PUBLICACION_BAREMACION",'2020/05/02');

define("DIA_PROVISIONALES",'2020/05/09');
define("DIA_DEFINITIVOS",'2020/05/10');
