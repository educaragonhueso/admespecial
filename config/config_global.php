...
define("DIA_INICIO_PRORROGA",'2020/03/02');
define("DIA_INICIO",'2020/03/04');
define("DIA_INICIO_INSCRIPCION",'2020/03/09');
define("DIA_MAX_SOL_ALUMNO",'2020/03/23');
define("DIA_FIN_INSCRIPCION",'2020/03/25');

define("DIA_SORTEO",'2020/03/31');

define("DIA_BAREMACION",'2020/04/02');
define("DIA_PUBLICACION_BAREMACION",'2020/04/05');

define("DIA_PROVISIONALES",'2020/04/29');
define("DIA_DEFINITIVOS",'2020/04/30');

define("DIA_SORTEO_FASE2",'2020/04/30');
